...
export const LOGIN_OTP_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
                ...
                <tr>
                  <td align="center" style="padding-top: 32px;">
                    <p style="margin: 0; font-size: 13px; color: #94a3b8;">
                      Need help? Contact <a href="mailto:paiseapesp@gmail.com" style="color: #6366f1; text-decoration: none; font-weight: 600;">paiseapesp@gmail.com</a>
                    </p>
                  </td>
                </tr>
