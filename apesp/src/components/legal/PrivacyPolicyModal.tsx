...
export function PrivacyPolicyModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl max-h-[85vh] p-0 gap-0 rounded-[2rem] border-border bg-card shadow-2xl overflow-hidden">
        {/* --- Header --- */}
        ...
        <ScrollArea className="h-full max-h-[60vh] overflow-y-auto">
          <div className="px-8 py-6 space-y-8 text-sm leading-relaxed text-muted-foreground">
            ...
            <p>
              ...
              our intelligent expense-sharing application collects, uses, and
              ...
              <div className="grid gap-4 pl-4 border-l-2 border-border ml-1">
                ...
                <div className="space-y-1">
                  ...
                  <p>
                    ...
                    store your photos permanently once the required information
                    is extracted.
                  </p>
                </div>
              </div>
